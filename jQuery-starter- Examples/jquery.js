...
//This will change the css when a user hovers over an area with a class of 'p1'. Since you are using hover, you have to invoke both mouseenter and mouseleave by having two functions inside the hover() method. When the mouse enters the .p1 area, it will change to Times New Roman, and when it leaves, it will change back to what it was originally, which is Georgia.
