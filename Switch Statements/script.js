// Task 1 of 2
// Finish the switch statement with two cases that check if phoneNumberPresent is true or false.
...
switch(phoneNumberPresent) {
    ...
    // Be sure to test to make sure you entered the values for the output variable properly. It would likely reduce a chance of error if you copy and paste the values in the quotes (including the punctuation).    
